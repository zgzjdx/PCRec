...
# cache = "./glove"
# glove = vocab.GloVe(name="6B", dim=300, cache=cache)
# category_ebd = []
...
# np.save("glove/category_embedding", category_ebd)


class PretrainedCategoryEmbedding():
    def __init__(self) -> None:
        super(PretrainedCategoryEmbedding, self).__init__()
        category_ebd = np.load("./category_embedding/42B_category_embedding.npy", allow_pickle=True)
